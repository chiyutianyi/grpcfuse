...
type AttrOut struct {
	...
	AttrValidNsec uint64 `protobuf:"varint,2,opt,name=attr_valid_nsec,json=attrValidNsec,proto3" json:"attr_valid_nsec,omitempty"`
...
func (x *AttrOut) GetAttrValidNsec() uint64 {
	if x != nil {
...
type EntryOut struct {
	...
	EntryValidNsec uint64 `protobuf:"varint,5,opt,name=entry_valid_nsec,json=entryValidNsec,proto3" json:"entry_valid_nsec,omitempty"`
	AttrValidNsec  uint64 `protobuf:"varint,6,opt,name=attr_valid_nsec,json=attrValidNsec,proto3" json:"attr_valid_nsec,omitempty"`
...
func (x *EntryOut) GetEntryValidNsec() uint64 {
	if x != nil {
...
func (x *EntryOut) GetAttrValidNsec() uint64 {
	if x != nil {
		return x.AttrValidNsec
	}
	return 0
...
var file_shared_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x69, 0x64, 0x5f, 0x6e, 0x73, 0x65, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52,
	...
	0x28, 0x04, 0x52, 0x0e, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x4e, 0x73,
	0x65, 0x63, 0x12, 0x26, 0x0a, 0x0f, 0x61, 0x74, 0x74, 0x72, 0x5f, 0x76, 0x61, 0x6c, 0x69, 0x64,
	0x5f, 0x6e, 0x73, 0x65, 0x63, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0d, 0x61, 0x74, 0x74,
	...
	0x12, 0x10, 0x0a, 0x03, 0x69, 0x6e, 0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x69,
